...
public class Export_000_002
{
    ...
    [Test]
    public void ExportPlaysZeroTest()
    {
        var context = serviceProvider.GetService<TheatreContext>();

        SeedDatabase(context);

        var actualXml = Serializer.ExportPlays(context, 7.5);
        var actualOutput = XDocument.Parse(actualXml);

        var expectedOutputValue = "<?xml version=\"1.0\" encoding=\"utf-16\"?><Plays><Play Title=\"A Raisin in the Sun\" Duration=\"03:10:00\" Rating=\"Premier\" Genre=\"Romance\"><Actors><Actor FullName=\"Perice Ricker\" MainCharacter=\"Plays main character in 'A Raisin in the Sun'.\" /><Actor FullName=\"Perice Ricker\" MainCharacter=\"Plays main character in 'A Raisin in the Sun'.\" /></Actors></Play><Play Title=\"Awake and Sing\" Duration=\"03:20:00\" Rating=\"2.3\" Genre=\"Romance\"><Actors><Actor FullName=\"Perice Ricker\" MainCharacter=\"Plays main character in 'Awake and Sing'.\" /><Actor FullName=\"Perice Ricker\" MainCharacter=\"Plays main character in 'Awake and Sing'.\" /></Actors></Play><Play Title=\"The Persianasd\" Duration=\"02:21:00\" Rating=\"6.5\" Genre=\"Comedy\"><Actors><Actor FullName=\"Joseito Melmoth\" MainCharacter=\"Plays main character in 'The Persianasd'.\" /></Actors></Play></Plays>";
        ...
        Assert.That(actualOutputXml, Is.EqualTo(expectedOutputXml).NoClip,
            $"{nameof(Serializer.ExportPlays)} output is incorrect!");
    }
