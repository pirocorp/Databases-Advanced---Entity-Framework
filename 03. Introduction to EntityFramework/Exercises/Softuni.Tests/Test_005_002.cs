...
namespace Softuni.Tests
{
    ...
    public class Test_005_002
    {
        ...
        public void ValidateOutput()
        {
            ...
            string result = StartUp.GetEmployeesFromResearchAndDevelopment(assertService).Trim();
        ...
        private void Seed(SoftUniContext context)
        {
            ...
            var salaries = new[]
            {
                642.1542352m, 5235, 4000.35232m, 25432, 2535235.33m
            };
