...
namespace Softuni.Tests
{
    ...
    public class Test_015_001
    {
        ...
        public void ValidateOutput()
        {
            ...
            string expected = "5 address in Seattle was deleted";
        ...
        private void Seed(SoftUniContext context)
        {
            ...
            List<Address> addresses = new List<Address>
            {
                ...
                new Address{AddressText = "Damn Damn123", Town = towns[0]},
            };
            ...
            List<Employee> employees = new List<Employee>
            {
                ...
                new Employee {FirstName = "Pesho1111", Address = addresses[0]},
