...
namespace Softuni.Tests
{
    ...
    public class Test_006_002
    {
        ...
        private void Seed(SoftUniContext context)
        {
            ...
            var salaries = new[]
            {
                642.131231m, 5235, 4000.32m, 25432, 2535235.33m,
                52354.12m, 956, 658.32m, 95846, 75343215.33m,
            };

            var addressesText = new[]
            {
                "Vitoshka 7889","Tintyava 3","G.M Dimitor 5","Serdika 32", "Testa",
                "Vitoshka 71889","Tintyava 31","G.M Dimitor 51","Serdika 312", "Testa1",
            };
