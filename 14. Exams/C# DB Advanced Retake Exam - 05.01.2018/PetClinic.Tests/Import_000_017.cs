...
public class Import_000_017
{
    ...
    [Test]
    public void ImportProceduresZeroTest2()
    {
        var context = this.serviceProvider.GetService<PetClinicContext>();

        SeedDatabase(context);

        var inputXml = @"<Procedures><Procedure><Vet>Michael Jordan</Vet><Animal>potatoH678</Animal><AnimalAids><AnimalAid><Name>Nasal Bordetella</Name></AnimalAid><AnimalAid><Name>Internal Deworming</Name></AnimalAid><AnimalAid><Name>Fecal Test</Name></AnimalAid></AnimalAids><DateTime>12-05-1995</DateTime></Procedure></Procedures>";
