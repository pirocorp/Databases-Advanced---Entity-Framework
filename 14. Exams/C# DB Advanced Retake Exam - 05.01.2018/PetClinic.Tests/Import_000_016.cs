...
public class Import_000_016
{
    ...
    [Test]
    public void ImportProceduresZeroTest1()
    {
        var context = this.serviceProvider.GetService<PetClinicContext>();

        SeedDatabase(context);

        var inputXml = @"<Procedures><Procedure><Vet>Pesho</Vet><Animal>etyhGgH678</Animal><AnimalAids><AnimalAid><Name>Nasal Bordetella</Name></AnimalAid><AnimalAid><Name>Internal Deworming</Name></AnimalAid><AnimalAid><Name>Fecal Test</Name></AnimalAid></AnimalAids><DateTime>12-05-1995</DateTime></Procedure></Procedures>";
