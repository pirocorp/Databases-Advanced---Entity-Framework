...
public class Import_000_005
{
    ...
    [Test]
    public void ImportAnimalsZeroTest2()
    {
        var context = this.serviceProvider.GetService<PetClinicContext>();

        var inputJson = @"[{'Name':'Name','Type':'c','Age':3,'Passport':{'SerialNumber':'anothev150','OwnerName':'Magda Bjork','OwnerPhoneNumber':'+359897765120','RegistrationDate':'15-04-2015'}},{'Name':'Name','Type':'InvalidTypeInvalidType','Age':3,'Passport':{'SerialNumber':'anothev650','OwnerName':'Magda Bjork','OwnerPhoneNumber':'+359897765120','RegistrationDate':'15-04-2015'}}]";
