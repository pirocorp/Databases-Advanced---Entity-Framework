...
public class Import_000_009
{
    ...
    [Test]
    public void ImportAnimalsZeroTest6()
    {
        var context = this.serviceProvider.GetService<PetClinicContext>();

        var inputJson = @"[{'Name':'DontInsertMe','Type':'cat','Age':3,'Passport':{'SerialNumber':'anothev150','OwnerName':'M','OwnerPhoneNumber':'+359897765120','RegistrationDate':'15-04-2015'}},{'Name':'DontInsertMe','Type':'cat','Age':3,'Passport':{'SerialNumber':'anothev650','OwnerName':'InvalidNameInvalidNameInvalidName','OwnerPhoneNumber':'+359897765120','RegistrationDate':'15-04-2015'}}]";
