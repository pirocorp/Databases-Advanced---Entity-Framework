...
public class Import_000_008
{
    ...
    [Test]
    public void ImportAnimalsZeroTest5()
    {
        var context = this.serviceProvider.GetService<PetClinicContext>();

        var inputJson = @"[{'Name':'DontInsertMe','Type':'cat','Age':3,'Passport':{'SerialNumber':'anothe1150','OwnerName':'Magda Bjork','OwnerPhoneNumber':'+359897765120','RegistrationDate':'15-04-2015'}},{'Name':'DontInsertMe','Type':'cat','Age':3,'Passport':{'SerialNumber':'anotv150','OwnerName':'Magda Bjork','OwnerPhoneNumber':'+359897765120','RegistrationDate':'15-04-2015'}}]";
