namespace CarDealer.Initializer
{
    ...
    public class Initializer
    {
        ...
        private void ImportCustomers()
        {
            ...
            object[] customerDtos = JsonConvert.DeserializeObject<CustomerDto[]>(jsonString);
        ...
        private void ImportCars()
        {
            ...
            object[] carDtos = JsonConvert.DeserializeObject<CarDto[]>(jsonString);
        ...
        private void ImportParts()
        {
            ...
            object[] partDtos = JsonConvert.DeserializeObject<PartDto[]>(jsonString);
        ...
        private void ImportSuppliers()
        {
            ...
            object[] suppliersDtos = JsonConvert.DeserializeObject<SupplierDto[]>(jsonString);
