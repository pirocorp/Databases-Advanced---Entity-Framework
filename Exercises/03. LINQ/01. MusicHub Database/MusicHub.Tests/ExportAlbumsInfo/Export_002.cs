namespace MusicHub.Tests.ExportAlbumsInfo
{
    using System;
    ...
    public class Export_002
    {
        ...
        {
            var context = this.serviceProvider.GetService<MusicHubDbContext>();

            SeedDatabase(context);

            var actual = StartUp.ExportAlbumsInfo(context, 2);

            var expected = @"-AlbumName: No history
-ReleaseDate: 03/05/2019
-ProducerName: Georgi Milkov
-Songs:
---#1
---SongName: Ride it
---Price: 8.50
