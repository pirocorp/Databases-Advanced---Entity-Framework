namespace MusicHub.Tests.ModelValidationTests
{
    ...
    public class Model_003
    {
        ...
        public void ValidateDeveloperEntity()
        {
            ...
            AssertPropertyIsOfType("PhoneNumber", typeof(string));
            AssertCollectionIsOfType("Albums", GetCollectionType(GetType("Album")));
        }
