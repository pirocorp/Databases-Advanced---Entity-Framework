namespace MusicHub.Tests.ModelValidationTests
{
    ...
    public class Model_005
    {
        ...
        {
            CurrentType = GetType("SongPerformer");

            AssertPropertyIsOfType("PerformerId", typeof(int));
            AssertPropertyIsOfType("Performer", GetType("Performer"));
            AssertPropertyIsOfType("SongId", typeof(int));
            AssertPropertyIsOfType("Song", GetType("Song"));
        }
