namespace MusicHub.Tests.ExportSongsAboveDuration
{
    using System;
    ...
    public class Export_004
    {
        ...
        public void ExportGamesByGenresZeroTest()
        {
            ...
            var actual = StartUp.ExportSongsAboveDuration(context, 480).Trim();
