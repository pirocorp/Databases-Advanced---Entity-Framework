namespace SoftUni.Tests.GetLatestProjects
{
    using System;
    ...
    {
        //TODO Change values of this tests !!! pls
        [Test]
        ...
        public static string AssertMethod(SoftUniContext context)
        {
            ...
            foreach (var latestStartedProject in latestStartedProjects)
            {
                ...
                content.AppendLine($"{latestStartedProject.StartDate.ToString("M/d/yyyy h:mm:ss tt")}");
            }
