namespace BusTicketsSystem.Client.Core.Commands
{
    ...
    public class BusStationTripsCommand : ICommand
    {
        ...
        public string Execute(string[] args)
        {
            ...
            foreach (var arrival in busStation.ExpectedArrivals.OrderBy(a => a.ArrivalTime))
            {
                result.AppendLine(
            ...
            foreach (var depart in busStation.ExpectedDeparture.OrderBy(d => d.DepartureTime))
            {
